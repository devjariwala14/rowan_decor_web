          ...
          while ($city = mysqli_fetch_array($result)) {
            ...
            <tr>
              ...
              <td>
                ...
                <a
                  href="javascript:viewdata('<?php echo $city["srno"] ?>','<?php echo $city["state_id"] ?>','<?php echo base64_encode($city["ctnm"]) ?>','<?php echo $city["status"] ?>');"><i class="fa-regular fa-eye"style="color:green"></i></a>
              </td>
            </tr>
            <?php
            $i++;
